...
public:
     ...
     * @fn getPower_mW
     * @brief Get power
     * @param _current For Current_LSB     
...
public:
     ...
     * @param maxcurrent   Maxcurrent for SHUNT_CAL
     * @param R_Shunt Shunt resistance for SHUNT_CAL
     ...
     */
    INA238_IIC(TwoWire *pWire, uint8_t i2caddr, float maxcurrent, float R_Shunt) : INA238() { _pWire = pWire; _addr = i2caddr; _current = maxcurrent; _shunt = R_Shunt;}
